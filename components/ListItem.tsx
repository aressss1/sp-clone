...
const ListItem: React.FC<ListItemProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="
            absolute transition opacity-0 rounded-full flex items-center justify-center bg-green-500 p-4 drop-shadow-md right-5 group-hover:opacity-100 hover:scale-110  mt-[6px]
        "
      >
